...
user-invocable: true
argument-hint: "[specialization] [--threshold 0.4] [--min-matches 3]"
---
...
```bash
python .claude/skills/mobius-evolve/scripts/load_underperformers.py [specialization] [--threshold 0.4] [--min-matches 3]
```
